...
import { EmployeeDashboardComponent, ViewTicketDialog } from './employee-dashboard/employee-dashboard.component';
...
import { EditTicketDialog } from './employee-dashboard/employee-dashboard.component';
